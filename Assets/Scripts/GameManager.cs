...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private Text stopwatchText;  // Reference to the stopwatch Text
    [SerializeField] private Text bestTimeText;   // Reference to the best time Text

    private float elapsedTime;
    private bool isTiming;

    public GameObject stopwatchGameObject; // Reference to the stopwatch GameObject
    ...
    public void StartGame(Texture2D jigsawTexture)
    {
        ...
        stopwatchGameObject.SetActive(false);
    }
    ...
    void Update()
    {
        ...
        if (isTiming)
        {
            stopwatchGameObject.SetActive(true);
